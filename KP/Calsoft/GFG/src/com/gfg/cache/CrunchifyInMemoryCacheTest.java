...
public class CrunchifyInMemoryCacheTest {
	...
	public void crunchifyTestAddRemoveObjects()
	{
		...
		// maxItems = 6
		CrunchifyInMemoryCache<String, String> cache = new CrunchifyInMemoryCache<String, String>(
				200, 500, 6);
		...
		System.out.println("6 Cache Object Added.. cache.size(): "
				+ cache.size());
		cache.remove("IBM");
		System.out
				.println("One object removed.. cache.size(): " + cache.size());

		cache.put("Twitter", "Twitter");
		cache.put("SAP", "SAP");
		System.out
				.println("Two objects Added but reached maxItems.. cache.size(): "
						+ cache.size());

	}

	public void crunchifyTestExpiredCacheObjects() throws InterruptedException
	{
		...
		System.out
				.println("Two objects are added but reached timeToLive. cache.size(): "
						+ cache.size());

	}

	public void crunchifyTestObjectsCleanupTime() throws InterruptedException
	{
		int size = 500000;
		...
		System.out.println("Cleanup times for " + size + " objects are "
				+ finish + " s");
